		...
		<div class="col-sm-5">
			<div class="contactinfo">
				<ul class="nav nav-pills">
					...
					<li><a href="https://github.com/buddylol123/ProjectCellphone"><i  class="fa fa-github"></i> Link GitHUB</a></li>
				</ul>
			</div>
		</div>
		<div class="col-sm-5">
		...
		<div class="col-sm-12">
			...
			<div class="shop-menu pull-right">
				<ul class="nav navbar-nav">
					...
					<li><a href="{{route('dangnhap')}}"><i class="fa fa-crosshairs"></i> Thanh toán</a></li>
					...
					<li><a href="{{route('dangky')}}"><i class="fa fa-lock"></i> Đăng ky</a></li>
